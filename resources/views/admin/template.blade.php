  ...
  <div class="d-flex">
    ...
    <div class="sidebar p-3">
      ...
      <ul class="nav flex-column">
        ...
        <li class="nav-item"><a href="/users" class="nav-link"><i class="fa-solid fa-users me-2"></i> Users</a></li>
        <li class="nav-item"><a href="/produk" class="nav-link"><i class="fa-solid fa-box me-2"></i> Produk</a></li>
        <li class="nav-item"><a href="/toko" class="nav-link"><i class="fa-solid fa-store me-2"></i> Toko</a></li>
